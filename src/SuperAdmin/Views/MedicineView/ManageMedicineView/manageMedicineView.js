...
import Body from "../../../Components/Medicine/ManageMedicine/manageMedicine";
class manageMedicineView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: false
...
export default manageMedicineView;
