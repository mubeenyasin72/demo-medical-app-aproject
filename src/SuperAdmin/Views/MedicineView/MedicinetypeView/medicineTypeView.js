...
import "./medtypeStyle.css";
import Header from "../../../Components/NavBar/navBar";
import SideBar from "../../../Components/SideBar/SideBarumar/sidebarPractice";
import Body from "../../../Components/Medicine/MedicineType/medicineType";
class medicineTypeView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: false
...
export default medicineTypeView;
